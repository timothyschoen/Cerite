...
void mcl::TextEditor::renderTextUsingAttributedString (juce::Graphics& g)
{
    ...
    CodeEditorComponent::ColourScheme colourScheme;
        ...
        for (auto& t : types)
            colourScheme.set (t.name, Colour (t.colour));
...
String mcl::TextEditor::getText()
{
    document.navigateSelections (TextDocument::Target::document, TextDocument::Direction::backwardCol, Selection::Part::head);
    document.navigateSelections (TextDocument::Target::document, TextDocument::Direction::forwardCol,  Selection::Part::tail);
    updateSelections();
    

    
    String content = document.getSelectionContent (document.getSelections().getFirst());
